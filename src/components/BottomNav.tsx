...
export function BottomNav() {
  ...
  return (
    <div className="w-full h-full bg-[#0A0B14]/95 flex items-center justify-around px-2 z-50 border-t border-white/5 backdrop-blur-xl shadow-[0_-8px_30px_rgba(0,0,0,0.5)]">
      {navItems.map((item) => {
